        ...
        >
          <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-gray-400 mt-4 text-lg tracking-wide">
              <TextType
                text={[" Ready to join the fusion? ⚡ ", "Creating your account...", "Welcome aboard, coder!"]}
                typingSpeed={75}
                pauseDuration={1500}
                showCursor={true}
                cursorCharacter="_"
          ...
          <div className="w-full max-w-md p-8 rounded-2xl bg-white/5 border border-cyan-400/20 shadow-[0_0_30px_rgba(56,189,248,0.25)] relative z-10">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white tracking-wide">
                Welcome to <span className="text-cyan-400 "><SplitText
                  text="CodeFusion"
                  className="text-md font-semibold text-center mb-[-4px]"
                  delay={230}
                  duration={0.6}
                  ease="power3.out"
                  splitType="chars"
